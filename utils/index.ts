...
export { default as isFn } from './checks/isFn'
export { default as isInt } from './checks/isInt'
export { default as isIP } from './checks/isIP'
export { default as isIPv4 } from './checks/isIPv4'
export { default as isIPv6 } from './checks/isIPv6'
...
export { default as get } from './iterables/get'
...
export { default as toLocale } from './sanitize/toLoc'
...
export { trim, ltrim, rtrim } from './strings/trim'
