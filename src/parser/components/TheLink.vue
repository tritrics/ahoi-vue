<script setup lang="ts">
  ...
  import type { Props, ElemType, Attributes, LinkString, LinkParser, LinkRouter, LinkNone, LinkType } from './TheLink'
  ...
  onBeforeMount(() => {
    ...
    } else if (props.to?.$type === 'link') {
      link.value = {
        source: 'parser',
        type: props.to.$attributes.type,
        data: props.to as ParserModel
      }
